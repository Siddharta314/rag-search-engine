...
def main() -> None:
    ...
    weighted_search = subparsers.add_parser("weighted-search", help="Perform a weighted search")
    weighted_search.add_argument("query", type=str, help="Query to search for")
    weighted_search.add_argument("--alpha", type=float, default=0.5, help="Alpha value for the search")
    weighted_search.add_argument("--limit", type=int, default=5, help="Limit the number of results")
    ...
    match args.command:
        ...
        case "weighted-search":
            ...
            for i, result in enumerate(results):
                ...
                print(f"  BM25: {result["bm25_score"]:.2f}, Semantic: {result["semantic_score"]:.2f}")
